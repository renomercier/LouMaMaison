...
--
-- Hôte : localhost
-- Généré le :  mar. 20 fév. 2018 à 22:44
...
(1, 1, 'stationnement=checked&wifi=checked&t%C3%A9l%C3%A9vision=checked', 'ee', 'ee', 50, 2, 1, 1, 'photo.jpg', '6', 6, 'hu', 'Montréal', 'hah aha', 3, 'nat', 2),
(6, 1, 'cintres=checked&fer+%C3%A0+repasser=checked', 'Une autre annonce', 'Très beau!', 70, 3, 2, 1, 'photo.jpg', '2', 23, 'Broue', 'Montréal', 'hah aha', 3, 'nat', 13),
(7, 1, 'cintres=checked&fer+%C3%A0+repasser=checked', 'Une autre annonce', 'Très beau!', 70, 3, 2, 1, 'photo.jpg', '2', 23, 'Broue', 'Montréal', 'hah aha', 3, 'nat', 13),
(8, 1, 'stationnement=checked&t%C3%A9l%C3%A9vision=checked&cintres=checked', 'Le titre de l\'annonce', 'sssssyyayayay', 50, 2, 1, 1, 'photo.jpg', '24', 23, 'rue', 'Montréal', 'h1h 1h1', 2, 'nat', 2);
...
CREATE TABLE `usager` (
  ...
  `coor_moyenComm` varchar(255) DEFAULT NULL,
...
('FFFffffafaf', 'rt', 'rt', 'profil.jpg', '23 rue  ddd', '000 000 0000', 'nnaannAA', 0, 0, 2, 'fg.com', 1, NULL, NULL),
('Gruuisser', 'gg', 'gg', 'profil.jpg', '54 rue...', '999 999 9999', 'hhahhhaH', 0, 0, 1, '', NULL, NULL, NULL),
('iiiiiiiiYYY', 'ii', 'ii', 'profil.jpg', '997 hhdhdh', '000 000 0000', 'hhaahhAA', 0, 0, 1, '', 1, NULL, NULL),
('nat', 'nat', 'nat', NULL, 'nat', '55', '12345', 0, 0, 1, '', 1, NULL, NULL),
('PPPPPPPPpeeee', 'ty', 'tu', 'profil.jpg', '43 reu  ddddd', '000 000 0000', 'nnaannAA', 0, 0, 1, 'ntsh.nnnn', 2, NULL, NULL),
('salim', 'salim', 'salim', NULL, 'salim', '44', '12345', 1, 0, 1, '', 1, NULL, NULL),
('Teeerererer', 're', 're', 'profil.jpg', '43', '000 000 0000', 'nnaannAA', 0, 0, 2, NULL, NULL, NULL, NULL);
